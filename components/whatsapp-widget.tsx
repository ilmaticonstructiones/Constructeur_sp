...
export const WhatsAppWidget = () => {
  const handleClick = () => {
    const message =
      "Hola, estoy interesado en sus servicios de construcción: pladur, trasteros y reformas integrales."
  ...
  return (
    <>
      ...
      <button
        ...
        aria-label="Abrir chat de WhatsApp para servicios de construcción en pladur, trasteros y reformas"
      >
        {/* WhatsApp Icon */}
        <svg
          width="24"
        ...
        <span className="absolute bottom-full right-0 mb-2 px-3 py-1 bg-gray-800 text-white text-sm rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap">
          ¡Chatea con nosotros!
          <span className="absolute top-full right-3 w-0 h-0 border-l-4 border-r-4 border-t-4 border-transparent border-t-gray-800"></span>
        </span>
      </button>

      {/* Structured Data for WhatsApp Contact */}
      <Script id="structured-data-whatsapp" type="application/ld+json">
        {JSON.stringify({
          ...
          areaServed: "España",
          description:
            "Especialistas en construcción, pladur, trasteros, reformas integrales, pintura y obra civil. Contacto directo vía WhatsApp.",
        })}
      </Script>
    </>
  )
